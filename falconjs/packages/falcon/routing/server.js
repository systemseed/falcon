...
const applyFalconRoutingConfiguration = (app, expressServer = express(), falconConfig = {}) => {
  ...
  expressServer.use('/static', express.static(`${app.dir}/static`, {
    maxAge: falconConfig.STATIC_CACHE_MAX_AGE || '7d',
    fallthrough: false,
  }));
...
const startFalconServer = (
  ...
  application
    .prepare()
    .then(() => {
      const server = applyFalconRoutingConfiguration(application, expressServer, falconConfig);
