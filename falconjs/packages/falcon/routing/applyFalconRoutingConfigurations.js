...
const applyFalconRoutingConfigurations = (app, expressServer = express(), falconConfig = {}) => {
  ...
  if (process.env.ENVIRONMENT && (process.env.ENVIRONMENT === 'development')) {
    ...
    if (process.env.HTTP_AUTH_USER && process.env.HTTP_AUTH_PASS && process.env.HTTP_AUTH_PASS !== "''" && process.env.HTTP_AUTH_USER !== "''") {
...
module.exports = applyFalconRoutingConfigurations;
