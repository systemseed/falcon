...
class MetatagCest {
  ...
  public function metatagsInResponse(\ApiTester $I) {
    ...
    $I->expectTo('See metatag title "Test appeal | Falcon Frontend Application" in response that generated by consumers_token module');
    $I->seeResponseContainsJson(['content' => 'Test appeal | Falcon Frontend Application', 'name' => 'title']);
