...
class MetatagCest {
  ...
  public function metatagsInResponse(\ApiTester $I) {
    ...
    $I->expectTo('See metatag title "Test news | Falcon" in response that generated by consumers_token module');
    $I->seeResponseContainsJson(['content' => 'Test news | Falcon', 'name' => 'title']);
